        ...
        >
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            >
              ...
              >
                A complete, healthcare-focused content system that handles your
                entire social media presence — so you can focus on what you do
                best.
              </p>
            </div>
            <div className="reveal steps-grid" style={{ marginTop: 56 }}>
              <div
                className="step-line"
                aria-hidden="true"
                style={{
              ...
              {[
                {
                  step: "01",
                  title: "We design",
                  desc: "A dedicated healthcare design team builds your daily creatives and reels, on-brand and on-schedule.",
                },
                {
                  step: "02",
                  title: "You post",
                  desc: "Receive ready-to-post content via WhatsApp or Drive. Posting takes under 2 minutes a day.",
                  offset: true,
                },
                {
                  step: "03",
                  title: "You grow",
                  desc: "More visibility, more trust, more patient inquiries — every single month.",
                },
              ].map(({ step, title, desc, offset }) => (
                <div
                  key={step}
                  ...
                  style={{
                    ...
                    padding: 28,
                    textAlign: "center",
                    transform: offset ? "translateY(12px)" : undefined,
                  }}
                >
                  <div
                    style={{
                    ...
                    >
                      {step === "01" && (
                        <>
                          ...
                          <path d="M12 22a10 10 0 110-20c4.5 0 8 3 8 6.5 0 2.5-2 3.5-4 3.5h-2a2 2 0 00-2 2c0 1 .5 1.5 1 2s1 1 1 2a3 3 0 01-3 3z" />
                        </>
                      )}
                      {step === "02" && (
                        <>
                ...
                <div className="table-min-width">
                  <div className="comp-table-row">
                    ...
                    <div
                      style={{
                        padding: "20px 16px",
                        borderBottom: "1px solid rgba(0,194,168,.2)",
                        background: "rgba(0,194,168,.1)",
                        textAlign: "center",
                        fontFamily: "Plus Jakarta Sans",
                        fontWeight: 700,
                  ...
                  {compRows.map(([feature, free, agency, palera], i) => (
                    <div key={feature} className="comp-table-row">
                      <div
                        style={{
                          padding: "16px 24px",
                          borderBottom:
